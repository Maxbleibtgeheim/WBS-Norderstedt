...
var DateNLP_Modal = class extends import_obsidian4.Modal {
  ...
  async submitForm(dateStr, ctrlKey, shiftKey) {
...
var ThePlugin = class extends import_obsidian6.Plugin {
  ...
  showRibbonButton() {
    ...
    if (!(import_obsidian6.Platform.isMobileApp || import_obsidian6.Platform.isMobile)) {
      setTimeout(() => {
        ...
        if (ribbonButton) {
          ribbonButton.addEventListener("mouseup", async (event) => {
            event.preventDefault();
            if (event.button === 2)
              await this.navigateToDNP((0, import_obsidian6.moment)().format("YYYY-MM-DD"), false, event.ctrlKey, event.shiftKey);
            else
              this.datePicker.open();
          });
        }
  ...
  async navigateToDNP(dateStr, shouldConfirmBeforeCreate = true, newPane = false, newHorizontalPane = false) {
    ...
    const dateForDNPToOpen = (0, import_obsidian6.moment)(/* @__PURE__ */ new Date(dateStr + "T00:00:00"));
    ...
    if (dnpFileThatExistsInVault != null) {
      ...
      if (shouldConfirmBeforeCreate === true) {
        createConfirmationDialog({
          cta: "Create",
          onAccept: async (dateStr2) => {
            const newDate = (0, import_obsidian6.moment)(new Date(dateStr2));
            openFile(await (0, import_obsidian_daily_notes_interface2.createDailyNote)(newDate), newPane, newHorizontalPane);
          },
        ...
        openFile(await (0, import_obsidian_daily_notes_interface2.createDailyNote)(dateForDNPToOpen), newPane, newHorizontalPane);
      }
    }
  }
};
